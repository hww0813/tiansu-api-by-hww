...
//import com.yuanqing.modal.video.VisitRate;
//import com.yuanqing.model.ExcelData;
//import com.yuanqing.project.tiansu.domain.assets.Camera;
//import com.yuanqing.project.tiansu.service.assets.ICameraService;
//import com.yuanqing.service.analysis.CameraDirectVisitedManager;
//import com.yuanqing.service.analysis.CameraVisitedManager;
//import com.yuanqing.service.analysis.ClientVisitManager;
//import com.yuanqing.service.analysis.VisitRateManager;
//import com.yuanqing.service.assets.*;
//import com.yuanqing.service.event.EventDetailManager;
//import com.yuanqing.service.system.SelfAuditManager;
//import com.yuanqing.service.user.LoginLogManager;
//import com.yuanqing.service.video.*;
//import com.yuanqing.util.*;
//import com.yuanqing.util.excel.ExportExcelUtils;
...
//
//    @Resource
//    private VisitRateManager visitRateManager;
//
//    @Resource
...
//
//    @Resource
//    private ClientTerminalManager clientTerminalManager;
//
//    @Resource
...
//    public Result sendReport(@RequestParam(value = "type", required = false) String type) {
//        try {
...
//
//                List<VisitRate> list = visitRateManager.getAllToReport(filters);
//
...
//                Map<String, Object> params = new HashMap<>();
//
//                List<JSONObject> list = clientTerminalManager.getAllToReport(filters);
//
//                JRDataSource jrDataSource = new JRBeanCollectionDataSource(list);
//
//                //print文件
...
//                Map<String, Object> params = new HashMap<>();
//
//                List<JSONObject> list = clientUserManager.getAllToReport(filters);
//
//                JRDataSource jrDataSource = new JRBeanCollectionDataSource(list);
//
//                //print文件
...
//                Map<String, Object> params = new HashMap<>();
//
//                List<JSONObject> list = serverTreeManager.getAllToReport(filters);
//
//                JRDataSource jrDataSource = new JRBeanCollectionDataSource(list);
//
//                //print文件
...
//                Map<String, Object> params = new HashMap<>();
//
//                List<JSONObject> list = clientManager.getClientVisitDetailToReport(filters);
//
//                JRDataSource jrDataSource = new JRBeanCollectionDataSource(list);
//
//                //print文件
...
//        if (cityCode == null) {
//            cityCode = visitRateManager.getRegion(cityCode);
//        }
//        filters.put("cityCode", cityCode);
...
//                Map<String, Object> params = new HashMap<>();
//
//                List<JSONObject> list = visitRateManager.getRateCameraCntToReport(filters);
//
//                JRDataSource jrDataSource = new JRBeanCollectionDataSource(list);
//
//                //print文件
...
//                Map<String, Object> params = new HashMap<>();
//
//                List<JSONObject> list = visitRateManager.getRateVisitedCntToReport(filters);
//
//                JRDataSource jrDataSource = new JRBeanCollectionDataSource(list);
//
//                //print文件
...
//                Map<String, Object> params = new HashMap<>();
//
//                List<JSONObject> list = visitRateManager.getRateVisitCntToReport(filters);
//
//                JRDataSource jrDataSource = new JRBeanCollectionDataSource(list);
//
//                //print文件
...
//                Map<String, Object> params = new HashMap<>();
//
//                List<JSONObject> list = visitRateManager.getRateClientCntToReport(filters);
//
//                JRDataSource jrDataSource = new JRBeanCollectionDataSource(list);
//
//                //print文件
...
//        List<JSONObject> all = visitRateManager.getRateClientCntToReport(filters);
...
//        List<JSONObject> all = visitRateManager.getRateVisitCntToReport(filters);
//        List<String> titles = new ArrayList();
//        titles.add("终端IP");
//        titles.add("摄像头IP");
//        titles.add("摄像头编号");
...
//        List<JSONObject> all = visitRateManager.getRateVisitedCntToReport(filters);
//        List<String> titles = new ArrayList();
//        titles.add("设备编号");
//        titles.add("摄像头名称");
//        titles.add("IP地址");
...
//        List<JSONObject> all = visitRateManager.getRateCameraCntToReport(filters);
//        List<String> titles = new ArrayList();
//        titles.add("设备编号");
//        titles.add("摄像头名称");
//        titles.add("IP地址");
...
//        ExcelData data = new ExcelData();
//        data.setName("服务器资源树");
//        List<JSONObject> all = serverTreeManager.getAllToReport(filters);
//        List<String> titles = new ArrayList();
//        titles.add("服务器编号");
//        titles.add("服务器名称");
//        titles.add("服务器IP");
...
//        List<Camera> list = cameraService.getList(filters);
...
//        ExcelData data = new ExcelData();
//        data.setName("终端");
//        List<JSONObject> all = clientTerminalManager.getAllToReport(filters);
//        List<String> titles = new ArrayList();
//        titles.add("设备编号");
//        titles.add("IP地址");
//        titles.add("MAC地址");
...
//        ExcelData data = new ExcelData();
//        data.setName("用户");
//        List<JSONObject> all = clientUserManager.getAllToReport(filters);
//        List<String> titles = new ArrayList();
//        titles.add("用户名");
//        titles.add("终端数");
//        titles.add("状态");
...
//        ExcelData data = new ExcelData();
//        data.setName("摄像头访问率");
//        List<VisitRate> all = visitRateManager.getAllToReport(filters);
//        List<String> titles = new ArrayList();
//        titles.add("地区名称");
//        titles.add("摄像头数");
//        titles.add("被访问摄像头");
